...
maxChromosomes = int(len(parsedDataset)/2)
...
probabilityMultipleMutation = 0.2
...
while(evolve):
    ...
    probabilityMutation = min(numDelta0/20, 1)
    probabilityMultipleMutation = min(numDelta0/100, 2)
...
#    if(numDelta0 > 50):
#        numElite = min(int(numElite*1.5), len(chromosomeList))
